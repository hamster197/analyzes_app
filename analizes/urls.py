...
urlpatterns = [
    ...
    path('admin_patient_list/edit/<pk>/', views.AdminPatientEdit.as_view(),
    ...
    path('admin_doctors_list/edit/<pk>/', views.DoctorEdit.as_view(),
         name='admin_doctors_edit_url', ),
    path('admin_doctors_list/delete/<pk>/', views.DoctorDelete.as_view(),
    ...
    path('admin_recomendations_list/edit/<pk>/', views.RecomendationEdit.as_view(),
         name='admin_recomendations_edit_url', ),
    path('admin_recomendations_list/delete/<pk>/', views.RecomendetionDelete.as_view(),
         name='admin_recomendations_delete_url', ),

    path('patinet_account_form/<pk>/', views.PatientAccount.as_view(),
         name='patinet_account_form_index_url', ),
    path('patinet_account_form/<pk>/<idd>/', views.PatientAccountForm.as_view(),
         name='patinet_account_form_url', ),
    path('patinet_analizes_formset/<pk>/', views.PatientAnalizesFormsetExample.as_view(),
